          ...
          <div class="flex items-center justify-center mt-0 hidden lg:flex ">
            <div class=" relative inline-block text-left dropdown">
              ...
              <div class="opacity-0 invisible dropdown-menu transition-all duration-300 transform origin-top-right -translate-y-2 scale-95">
                <div
                  class="absolute right-0 w-30 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                ...
                >
                  <div class="py-1">
                    <a
                      ...
                      tabindex="0"
                      className="text-gray-700 flex justify-left space-x-5 w-full px-4 py-2 text-sm leading-5 text-left hover:bg-gray-200"
                      role="menuitem"
                    >
                      <span>
                        <svg
