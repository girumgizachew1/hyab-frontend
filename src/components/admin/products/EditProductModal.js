...
const EditProductModal = (props) => {
  ...
  useEffect(() => {
    console.log(data.editProductModal);
    setEditformdata({
      ...
      pImageUrl: data.editProductModal.pImageUrl,
  ...
  const submitForm = async (e) => {
    ...
    try {
      let responseData = await editProduct(editformData, urls);
              ...
              {editformData.pImages ? (
                <div className="flex space-x-1">
                  <img
                    ...
                    src={`${apiURL}/uploads/products/${editformData.pImageUrl[0]}`}
                    alt="productImage"
                  />
                  <img
                    className="h-16 w-16 object-cover"
