...
import { getAllCategory, getActiveCategory } from "../../admin/categories/FetchApi";
import { getAllProduct,getActiveProduct, productByPrice } from "../../admin/products/FetchApi";
import "./style.css";
