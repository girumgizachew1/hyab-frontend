    ...
    <Fragment>
      ...
      <div className="flex lg:flex-row w-screen flex-col">
        <div className="banner basis-1/4">
          <div>
            <img
              className="w-full py-1 lg:hidden"
              src={comingsoon}
              alt="img"
            ></img>

            <img
              className="w-full md:ml-16 py-10 px-10 hidden lg:block"
              src={comingsoon2}
              alt="img"
            ></img>
          </div>
        ...
        <div>
          <h1 className="ml-20 py-4 text-xl lg:text-4xl text-gray-800 font-semibold mx-auto">
