...
import ProductDetailsSectionThree from "./ProductDetailsSectionThree";
    ...
    try {
      ...
      setTimeout(() => {
        if (responseData.Product) {
          ...
          setPimages(responseData.Product.pImageUrl);
  ...
  return (
    <Fragment>
      ...
      <section className="m-4 md:mx-12 md:my-6">
        <div className="grid grid-cols-2 md:grid-cols-12 md:m-auto">
          <div className="hidden md:block md:col-span-1 md:flex md:flex-col md:space-y-4 md:mr-2">
            {sProduct.pImageUrl.map((image, index) => {
              return (
                <img
                  onClick={(e) =>
          ...
          <div className="col-span-2 mt-8 md:mt-0 md:col-span-6 md:ml-6 lg:ml-12">
            ...
            <div className="my-4 md:my-6">
              ...
              >
                ...
                <select name="cars" id="cars">
                  {sizes.map((size) => {
                    return <option value="volvo">{size}</option>;
                  })}
                </select>
                {/* Quantity Button End */}
              </div>
      ...
      <ProductDetailsSectionThree id={id} />
    </Fragment>
  );
};
